import unittest
from .utils import FakeResponse, captured_output, captured_binary_output
...
class TestNONColorized(unittest.TestCase):
    def setUp(self):
        ...
        global reqst
        from reqst import main as reqst
    ...
    def test_metadata(self):
        ...
        with captured_output() as (stdout, stderr):
            reqst.handle_metadata_output(response)
    ...
    def test_plain(self):
        text = "const1"
        with captured_output() as (stdout, stderr):
            reqst.handle_plain_output(text)
    ...
    def test_binary(self):
        ...
        with captured_binary_output() as (stdout, stderr):
            reqst.handle_binary_output(content)
